...
df = pd.read_excel('PandasSubtablePractice.xlsx')
...
core_type = input("Enter the core type (e.g., T100-26): ").strip()
dimension = input("Enter the dimension to retrieve (e.g., Outer Diameter (mm)): ").strip().lower()
